  ...
  if (money_format_settings) {
    return (
      <div className="dashboardPage">
        ...
        <Row className="dashboardRow" gutter={[24, 24]}>
          <Col className="gutter-row w-full" sm={{ span: 24 }} md={{ span: 24 }} lg={{ span: 18 }}>
            <div className="whiteBox shadow dashboardCard dashboardPreviewPanel">
        ...
        <Row className="dashboardRow" gutter={[24, 24]}>
          <Col className="gutter-row w-full" sm={{ span: 24 }} lg={{ span: 12 }}>
            <div className="whiteBox shadow dashboardCard dashboardTableCard">
              <h3>{translate('Recent Invoices')}</h3>
